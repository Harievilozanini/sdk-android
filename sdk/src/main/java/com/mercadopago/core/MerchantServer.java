...
public class MerchantServer {
    ...
    public static Call<Customer> getCustomer(Context context, String merchantBaseUrl, String merchantGetCustomerUri, String merchantAccessToken) {
    ...
    public static Call<Payment> createPayment(Context context, String merchantBaseUrl, String merchantCreatePaymentUri, MerchantPayment payment) {

        MerchantService service = getService(context, merchantBaseUrl);
        return service.createPayment(ripFirstSlash(merchantCreatePaymentUri), payment);
    }

    public static Call<Discount> getDiscount(Context context, String merchantBaseUrl, String merchantGetDiscountUri, String merchantAccessToken, String itemId, Integer itemQuantity) {
